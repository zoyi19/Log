...
from opencood.models.scope_modules.scope_attn import SCOPE
from opencood.models.scope_modules.temporal_late_fusion import LateFusion
from opencood.models.scope_modules.temporal_fusion_lstm import TemporalFusion_lstm
...
class PointPillarScopeLRF(nn.Module):
    def __init__(self, args):
        super(PointPillarScopeLRF, self).__init__()
        ...
        if 'resnet' in args['base_bev_backbone']:
            self.backbone = ResNetBEVBackbone(args['base_bev_backbone'], 128) # orignal 64
        else:
            self.backbone = BaseBEVBackbone(args['base_bev_backbone'], 128) # orignal 64
