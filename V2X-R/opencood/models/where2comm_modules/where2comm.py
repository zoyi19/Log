...
class Communication(nn.Module):
    ...
    def forward(self, batch_x, batch_confidence_maps, record_len, pairwise_t_matrix):
        ...
        for b in range(B):
            ...
            # print(self.thre, batch_x[b].shape, communication_vol[-1])
        ...
        communication_vol = np.sum(communication_vol)/B

        communication_masks = torch.concat(communication_masks, dim=0)
        return batch_communication_maps, communication_masks, communication_vol#communication_rates